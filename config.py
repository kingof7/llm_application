...
"""
    ...
    {
        "input": "연봉이 5천만원인 직장인의 소득세는 얼마에요?",
        "answer": """소득세법 제55조(세율)에 따르면, 연봉 5천만원의 직장인의 종합소득세는 다음과 같이 계산할 수 있습니다.
        1. 1,400만원 이하: 1,400만원 * 6% = 84만원
        2. 1,400만원 초과 5,000만원 이하: (5,000만원 - 1,400만원) * 15% = 540만원
        따라서 총 소득세는 84만원 + 540만원 = 624만원입니다.
        단, 여기서 기본공제, 인적공제, 특별세액공제 등을 적용하면 실제 납부해야 할 세액은 달라질 수 있습니다.
"""
    },
    {
